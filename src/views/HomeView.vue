...
const diffArray = (arr1, arr2) => {
  ...
  if (arr1.length > arr2.length) return arr1.filter(x => !arr2.includes(x))
  if (arr2.length > arr1.length) return arr2.filter(x => !arr1.includes(x))
  if (arr1.every(x => !arr2.includes(x)) || arr2.every(x => !arr1.includes(x))) return arr1.concat(arr2)
}
            ...
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">Cupidatat minim id
                  ...
                  aliqua proident mollit ullamco exercitation tempor. Sint aliqua anim nulla sunt mollit id pariatur in
                  voluptate cillum.</p>
