...
const products = [
  {
    ...
    imageUrl:
        '/images/produits/produit1.png',
  },
  {
    name: 'Cuvette WC',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,',
    imageUrl:
        '/images/produits/produit2.png',
  },
  {
    name: 'Baignoire',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,',
    imageUrl:
        '/images/produits/produit3.png',
  },
  {
    name: 'lavabo centré',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,',
    imageUrl:
        '/images/produits/produit4.png',
  },
]
</script>
<template>
  <div class="py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8 z-20">
      <div class="flex justify-between items-center">
        ...
        <a href="/products" class="leading-8 text-primary cursor-pointer">Voir tous
